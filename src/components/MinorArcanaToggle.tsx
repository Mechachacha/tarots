      ...
      <div className="mb-6">
        <label className="flex items-center gap-3 cursor-pointer">
          <input
            ...
            className="w-5 h-5 text-tarot-purple border-tarot-dark/30 rounded focus:ring-2 focus:ring-tarot-purple focus:ring-offset-2 accent-tarot-purple"
            {...props}
          />
          <span className="text-tarot-dark font-medium">小アルカナを使用する（78枚）</span>
          <span className="text-sm text-tarot-dark/50 ml-auto">
            {checked ? 'ON' : 'OFF（大アルカナのみ 22枚）'}
          </span>
        </label>
        <p className="mt-2 text-sm text-tarot-dark/60">
